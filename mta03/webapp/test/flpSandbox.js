		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "MTA Fiori 03",
									"targetURL": "#nsmta03mta03-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsmta03mta03-display": {
								"semanticObject": "nsmta03mta03",
								"action": "display",
								"description": "MTA Fiori 03",
								"title": "MTA Fiori 03",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.mta03.mta03",
									"url": sap.ui.require.toUrl("ns/mta03/mta03")
								}
							}
						}
					}
